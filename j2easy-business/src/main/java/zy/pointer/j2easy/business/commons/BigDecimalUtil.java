...
public class BigDecimalUtil {
    ...
    public static String strAdd(String v1, String v2,int scale) {   
        ...
        BigDecimal b1 = new BigDecimal(v1);   
        BigDecimal b2 = new BigDecimal(v2);   
        return b1.add(b2).setScale(scale, BigDecimal.ROUND_HALF_DOWN).toPlainString();   
    }   
    /**  
     * 提供精确的减法运算。  
     *  
    ...
    public static String strSub(String v1, String v2,int scale) {   
        ...
        BigDecimal b1 = new BigDecimal(v1);   
        BigDecimal b2 = new BigDecimal(v2);
        return b1.subtract(b2).compareTo(BigDecimal.ZERO) == 0 ? "0" : b1.subtract(b2).setScale(scale, BigDecimal.ROUND_HALF_DOWN).toPlainString();
    }   
    /**  
     * 提供精确的乘法运算。  
     *  
    ...
    public static String strMul2(String v1, String v2,int scale) {   
        ...
        BigDecimal b1 = new BigDecimal(v1);   
        BigDecimal b2 = new BigDecimal(v2);   
        return b1.multiply(b2).setScale(scale, BigDecimal.ROUND_HALF_DOWN).toPlainString();   
    }   
    /**  
    ...
    public static String strDiv(String v1, String v2, int scale) {   
        ...
        BigDecimal b1 = new BigDecimal(v1);   
        BigDecimal b2 = new BigDecimal(v2);   
        return b1.divide(b2, scale, BigDecimal.ROUND_HALF_DOWN).toPlainString();   
    }   
    ...
    public static BigDecimal strRemainder(String v1,String v2, int scale){   
        ...
        BigDecimal b1 = new BigDecimal(v1);   
        BigDecimal b2 = new BigDecimal(v2);   
        return b1.remainder(b2).setScale(scale, BigDecimal.ROUND_HALF_DOWN);   
    }   
    /**  
     * 取余数  string  
     * @param v1  
    ...
    public static String strRemainder2Str(String v1,String v2, int scale){   
        ...
        BigDecimal b1 = new BigDecimal(v1);   
        BigDecimal b2 = new BigDecimal(v2);   
        return b1.remainder(b2).setScale(scale, BigDecimal.ROUND_HALF_DOWN).toPlainString();   
    }   
    ...
    public static BigDecimal bigRemainder(BigDecimal v1,BigDecimal v2, int scale){   
        ...
        return v1.remainder(v2).setScale(scale, BigDecimal.ROUND_HALF_DOWN);   
    }   
...
//         Object r = b1.subtract(b2).compareTo(b3);
    	...
    	BigDecimal a = new BigDecimal("0.00000000").setScale(8, BigDecimal.ROUND_HALF_DOWN);
